 ...
 */
function outfit_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => '<i class="icon-left fa fa-chevron-left"></i>&nbsp;'.__( 'Previous', 'outfit-standalone' ),
        'next_string'     => __( 'Next', 'outfit-standalone' ).'<i class="icon-right fa fa-chevron-right"></i>',
