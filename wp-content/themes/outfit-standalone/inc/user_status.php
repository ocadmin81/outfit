...
add_action('init', 'outfit_users_status_init');
add_action('admin_init', 'outfit_users_status_init');
function outfit_users_status_init(){
...
function outfit_is_user_online($id){
	$logged_in_users = get_transient('users_status'); //Get the active users from the transient.
...
function outfit_user_last_online($id){
	$logged_in_users = get_transient('users_status'); //Get the active users from the transient.
