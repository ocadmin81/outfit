...
<body>
	<?php 
		global $redux_demo;
		$outfitEmail = $redux_demo['contact-email'];
		$outfitPhone = $redux_demo['contact-phone'];
	...
	<div style="width: 100%;">
		<div class="classiera-email-topbar" style="background:#232323; padding: 5px 30px;">
            <div class="classiera-column-3" style="width: 25%; display: inline-block;">
                ...
                <span style="color: #aaaaaa; font-size:12px; font-family: 'Lato', sans-serif;">
					<?php echo sanitize_email($outfitEmail); ?>
				</span>
            </div>
            <div class="classiera-column-3" style="width: 25%; display: inline-block;">
                ...
                <a href="tel:+496170961709" style="text-decoration: none; color: #aaaaaa; font-size:12px; font-family: 'Lato', sans-serif;"><?php echo esc_html($outfitPhone); ?></a>
            </div>
            <div class="classiera-column-6" style="width: 48%; display: inline-block; text-align: right;">
                ...
                <a class="classiera-email-social-icon" href="<?php echo esc_url($outfitFacebook); ?>" style="background: #444444; height: 30px; width: 30px; text-align: center; display: inline-block; line-height:30px;">
                ...
                <a class="classiera-email-social-icon" href="<?php echo esc_url($outfitTwitter); ?>" style="background: #444444; height: 30px; width: 30px; text-align: center; display: inline-block; line-height:30px;">
                ...
                <a class="classiera-email-social-icon" href="<?php echo esc_url($outfitGoogle); ?>" style="background: #444444; height: 30px; width: 30px; text-align: center; display: inline-block; line-height:30px;">
		...
		<div class="classiera-email-logo" style="width: 100%; background: #fff; text-align: center; padding: 25px 0; box-shadow: 0 4px 2px -2px rgba(0, 0, 0, 0.15);">
            <img src="<?php echo esc_url($outfitlogo); ?>" alt="<?php echo esc_html($blog_title); ?>">
        </div>