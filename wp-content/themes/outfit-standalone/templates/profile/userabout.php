<?php 
	...
	$classieraAuthorIMG = outfit_get_profile_img($classieraAuthorIMG);
	if(empty($classieraAuthorIMG)){
		$classieraAuthorIMG = outfit_get_avatar_url ($classieraAuthorEmail, $size = '150' );
	}	
	$classieraOnlineCheck = outfit_user_last_online($user_ID);
