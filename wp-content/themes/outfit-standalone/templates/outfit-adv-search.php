...
<form id="advanced-search-form" method="post" action="<?php echo esc_url(outfit_get_page_url('advsearch')); ?>">
			<div class="search-form-outer">
				...
				<div class="inner-search-box ab">
					<div class="inner-search-heading hidden-xs"><?php esc_html_e( 'גיל ומידה', 'outfit-standalone' ); ?></div>
					<select id="ageGroup" name="postAgeGroup" class="form-control form-control-sm ageGroup">
						...
						<?php else: ?>
							<option value=""><?php esc_html_e( 'גיל ומידה', 'outfit-standalone' ); ?></option>
						<?php endif; ?>
						<?php
				...
				<div class="inner-search-box ab address">
					<div class="inner-search-heading hidden-xs"><?php esc_html_e( 'אזורי הגעה', 'outfit-standalone' ); ?></div>
